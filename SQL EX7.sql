create database planet_Express;
USE planet_Express;
...
-- 7.1 Who receieved a 1.5kg package?
    ...
    select name,weight from client join package on client.AccountNumber=package.recipient where weight=1.5;


-- 7.2 What is the total weight of all the packages that he sent?
    select name, sum(weight) from client join package on client.AccountNumber=package.sender  where sender=2;
